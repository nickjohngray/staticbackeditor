...
exports.deletePageComponent = function (pageName, repoName) { return __awaiter(void 0, void 0, void 0, function () {
...
exports.makePageComponent = function (pageName, repoName, pageContent) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent();
                _a.label = 3;
            case 3: return [4 /*yield*/, fs_1["default"].writeFileSync(pageComponentPath, pageContent)];
            case 4:
                _a.sent();
                return [2 /*return*/, true];
            case 5:
...
exports.startUpPreviewRepo = function (repoName) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        try {
            ...
            repoInstallProcess.on('exit', function (code) {
                ...
                if (err) {
                    console.log('an error occurred while trying to install node_modules for ' + repoName + ' error is ' + err);
                    return;
                }
